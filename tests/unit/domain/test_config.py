...
class TestDetectionConfig:
    ...
    def test_custom_values(self):
        ...
        config = DetectionConfig(pixel_to_mm=0.01, min_diameter_mm=2.0, max_diameter_mm=15.0)
    ...
    def test_display_options(self):
        ...
        config = DetectionConfig(show_contours=False, show_diameter_line=False, show_label=False)
...
class TestToleranceConfig:
    ...
    def test_tolerance_range(self):
        ...
        config = ToleranceConfig(enabled=True, nominal_mm=10.0, tolerance_mm=0.1)
